    ...
    children: [
      {
        ...
        icon: 'palmtree',
        children: [
          { label: 'Time Off Request', path: '/time/time-off/requests', source: 'time-off-request.html', status: 'todo' },
      ...
      },
      {
        ...
        icon: 'fingerprint',
        children: [
          { label: 'Attendance', path: '/time/attendance', source: 'time-attendance.html', status: 'todo' },
