...
export const BRANCH_SEED: Branch[] = [
  {
    ...
    phone: '+62215551000',
    zip: { zip: '10110', timezone: 'Asia/Jakarta' },
  ...
  },
  {
    ...
    phone: '+62221234567',
    zip: { zip: '40111', timezone: 'Asia/Jakarta' },
  ...
  },
  {
    ...
    phone: '+62247654321',
    zip: { zip: '50131', timezone: 'Asia/Jakarta' },
...
export const JOB_GRADE_SEED: JobGrade[] = [
  { id: 'jg-staff', name: 'Staff', gradeCode: 'S', parentId: null, salaryRangeFrom: null, salaryRangeTo: null, createdAt: at('2026-01-12') },
  { id: 'jg-manager', name: 'Manager', gradeCode: 'M', parentId: null, salaryRangeFrom: null, salaryRangeTo: null, createdAt: at('2026-01-12') },
  {
    id: 'jg-staff-1',
    name: 'Staff 1',
    gradeCode: 'S.1',
