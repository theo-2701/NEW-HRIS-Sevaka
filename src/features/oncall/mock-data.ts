...
export const ONCALL: OncallAssignment[] = [
  { id: 'oncall-1', employeeId: 'emp-hendra', standbyStartAt: '2026-07-27T21:00:00+07:00', standbyEndAt: '2026-07-28T06:00:00+07:00', maxCalloutHours: 4.0, oncallStatus: 'ACTIVATED', requiresExtraApprovalReason: null, assignmentNote: 'Month-end payroll system standby.', createdBy: 'emp-hendra', approvedBy: 'emp-sari' },
