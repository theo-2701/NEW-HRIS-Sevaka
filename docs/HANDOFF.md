...
| Node | 22.17.0 (`.nvmrc`) |
| Sudah dikonversi | **Auth** (10 layar), **Dashboard**, **Employee Directory**, **Employee Profile** (7 seksi), **New Joiner** (list + Add Employee), **Employee Transfer** (list + dashboard), **Mass Resignation**, **PTKP Adjustment**, **Manpower & Requisition**, **Reprimand** (+ Type Setting) — Batch 1 selesai, plus **Time Off** lengkap — Request, Balance, Settings (Batch 2 berjalan) |
