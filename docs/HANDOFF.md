...
| Node | 22.17.0 (`.nvmrc`) |
| Sudah dikonversi | **Auth** (10 layar), **Dashboard**, **Employee Directory**, **Employee Profile** (7 seksi), **New Joiner** (list + Add Employee), **Employee Transfer** (list + dashboard), **Mass Resignation**, **PTKP Adjustment**, **Manpower & Requisition**, **Reprimand** (+ Type Setting) — Batch 1 selesai, plus **Time Off** lengkap — Request, Balance, Settings — **Attendance** (+ Settings), **Overtime**, **Calendar**, **Scheduler** (Index + Schedule), dan **On Call** (Schedule + Activity) — Batch 2 selesai. Batch 3 berjalan: **Benefit Reimbursement**, **Loan** (+ detail), **Cash Advance**, **Disbursement & Receivables**, **Finance Settings** |
